...
- **다음 작업 (2개)**:
  - `docs/future/faster-qwen3-tts.md` — faster-qwen3-tts 통합 (TTS 5초→200ms). **다음 세션에서 진입**.
  - `docs/future/v4-vision.md` — v4 비전 deep interview. faster-qwen3 끝나면.
...
- **핵심 변경**:
  ...
  - TTS = **MeloTTS 또는 Qwen3-TTS 토글** (ADR-006) — 현재 Melo. faster-qwen3 통합 예정.
...
7. **v3 마무리 작업 진행 시**: `docs/future/faster-qwen3-tts.md`
8. **v4 시작 시**: `docs/future/v4-vision.md` (deep interview 질문 §6 참조)
